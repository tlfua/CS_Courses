...
int use_matrix()
{
    ...
    std::cout << A;
    std::cout << "The (1,1) entry of matrix A is: " << A.get(1, 1) << "\n\n";
    ...
    A.set(1, 1, 2);  A.set(1, 2, 1);  A.set(1, 3, 1);  A.set(1, 4, 0);
    A.set(2, 1, 4);  A.set(2, 2, 3);  A.set(2, 3, 3);  A.set(2, 4, 1);
    A.set(3, 1, 8);  A.set(3, 2, 7);  A.set(3, 3, 9);  A.set(3, 4, 5);
    A.set(4, 1, 6);  A.set(4, 2, 7);  A.set(4, 3, 9);  A.set(4, 4, 8);
    ...
    matrix AA(3, 3);
    AA.set(1, 1, 3);  AA.set(1, 2, 17);  AA.set(1, 3, 10);
    AA.set(2, 1, 2);  AA.set(2, 2, 4);   AA.set(2, 3, -2);
    AA.set(3, 1, 6);  AA.set(3, 2, 18);  AA.set(3, 3, -12);
