...
def router_tests():
    ...
    #10
    log_debug("last test {}\n")
    packet = mk_pkt(hwsrc='30:00:00:00:00:01', hwdst='20:00:00:00:00:01', ipsrc='192.168.1.100', ipdst='172.0.0.2',
                    ttl=63)

    log_debug("last test {}\n")
    s.expect(PacketInputEvent("router-eth0", packet), "IP packet to be forwarded to 172.0.0.2 should arrive on router-eth0")

    #11
    arp_request  = create_ip_arp_request('10:00:00:00:00:01', '192.168.1.1', '172.0.0.2')
